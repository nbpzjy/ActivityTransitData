 ...
 */
public class ClearableEditTxt extends EditText implements EditText.OnFocusChangeListener {

    public static final String TAG = "ClearableEditTxt";

    public ClearableEditTxt(Context context) {
        this(context, null);
    }

    public ClearableEditTxt(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextStyle);
    }

    public ClearableEditTxt(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ClearableEditTxt(Context context, AttributeSet attrs, int defStyleAttr, int
            defStyleRes) {
