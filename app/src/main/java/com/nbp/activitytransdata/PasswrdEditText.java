 ...
 */
public class PasswrdEditText extends EditText implements EditText.OnFocusChangeListener {

    public static final String TAG = "PasswordEditText";

    public PasswrdEditText(Context context) {
        super(context);
        init(context, null, 0, 0);
    }

    public PasswrdEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0, 0);
    }

    public PasswrdEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr, 0);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public PasswrdEditText(Context context, AttributeSet attrs, int defStyleAttr, int
            defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int
        ...
        TypedArray a = theme.obtainStyledAttributes(attrs, R.styleable.ClearableEditTxt,
                defStyleAttr, defStyleRes);

        int rightDrawableColor = a.getColor(R.styleable.ClearableEditTxt_right_drawable_color,
                Color.BLACK);
        ...
        mVisibilityOffDrawable = ResourcesCompat.getDrawable(context.getResources(), R.mipmap
